...
5. **Test installation through the skills CLI.** Install the full set into a disposable project. Confirm `ronin-mode`, one sibling skill, and `ronin-core` resolve together. Remove the test install with the same CLI.
