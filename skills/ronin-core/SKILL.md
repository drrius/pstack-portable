...
Skills locate these files as a sibling skill directory: from any installed ronin skill, the contract is at `../ronin-core/HOST_CONTRACT.md` and the personas are under `../ronin-core/personas/`. This holds wherever skills are installed together — copied or symlinked, global or project-local.
