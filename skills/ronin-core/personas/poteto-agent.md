---
name: poteto-agent
description: Prompt for a native subagent running `/ronin`. Resume an existing Poteto Agent worker for the conversation rather than spawning a sibling. Reads the host contract and `ronin` in full before any work.
---
