---
name: ronin-principle-sequence-verifiable-units
...
The sequencing complement to the **ronin-principle-prove-it-works** principle skill, which keeps each check real, and the **ronin-principle-build-the-lever** principle skill, which makes the per-unit check cheap.
