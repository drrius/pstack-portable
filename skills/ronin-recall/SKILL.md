...
An adjacent feature or ticket stays out unless it blocks this one. When the capsule and thread lines outgrow a screen, cut detail before you cut threads. Write the brief through the **ronin-unslop** skill, cite chat findings using the stable identifier supplied by the host and shared-record findings by their source (pull request, ticket, chat permalink, or error-tracker issue), and sanitize private context before any public output.
