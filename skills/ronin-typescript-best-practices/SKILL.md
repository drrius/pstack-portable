---
name: ronin-typescript-best-practices
description: TypeScript best practices. Use when reading or editing any .ts or .tsx file.
---

# TypeScript best practices

Apply the **ronin-principle-type-system-discipline** principle skill first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Validate where data crosses in; trust types inside. See the **ronin-principle-boundary-discipline** principle skill. |
