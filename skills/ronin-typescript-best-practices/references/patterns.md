...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see the **ronin-principle-type-system-discipline** and **ronin-principle-boundary-discipline** principle skills.
...
Validate once where data crosses in; trust types inside. See the **ronin-principle-boundary-discipline** principle skill.
